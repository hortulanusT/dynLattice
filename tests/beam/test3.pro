...
params.rod_details.shear_modulus = 10.16e10;
...
params.force_model.minIncr = .005;
...
Input.groupInput.fixed_left.xval = "cos(5/180 * PI) * 0.254";
Input.groupInput.fixed_right.xval = "cos(5/180 * PI) * 0.254";
...
Output.paraview.reportIntervall = 25;