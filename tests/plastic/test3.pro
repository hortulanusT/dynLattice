...
params.scale=1.;
params.rod_details.material.yieldCond  = "  abs(dx/( 700-b_dx)/$(params.scale)^2)^2.04 ";
params.rod_details.material.yieldCond += "+ abs(dy/( 700-b_dy)/$(params.scale)^2)^2.04 "; 
params.rod_details.material.yieldCond += "+ abs(dz/(1470-b_dz)/$(params.scale)^2)^1.76 ";
params.rod_details.material.yieldCond += "+ abs(rx/(0.62-b_rx)/$(params.scale)^3)^2.09 ";
params.rod_details.material.yieldCond += "+ abs(ry/(0.62-b_ry)/$(params.scale)^3)^2.09 ";
params.rod_details.material.yieldCond += "+ abs(rz/(0.56-b_rz)/$(params.scale)^3)^1.73 ";
