...
params.force_model.dispIncr = 5e-4;
params.force_model.nodeGroups = ["free", "free"];
params.force_model.dofs = ["dx", "rx"];
params.force_model.factors = ["20e-3", "2.*PI"]; 
...
model.model.model.diriFixed.dofs += [ "rx", "ry", "rz" ];
model.model.model.diriFixed.factors += [ 0., 0., 0. ];

model.model.model.diriFixed.nodeGroups += [ "free", "free" ];
model.model.model.diriFixed.dofs += ["ry", "rz"];
