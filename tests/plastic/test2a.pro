...
params.rod_details.material.yieldCond  = "  abs(dx+b_dx) ";
params.rod_details.material.yieldCond += "+ abs(dy+b_dy) "; 
params.rod_details.material.yieldCond += "+ abs(dz+b_dz) "; 
params.rod_details.material.yieldCond += "+ abs((rx+b_rx)/0.12) "; 
...
params.force_model.stretch.scaleFunc += " + if(i>4001, 0.0098*(i-4001),0) - if(i>5001, 0.0098*(i-5001),0)";
params.force_model.stretch.scaleFunc += " + if(i>5001,-0.0114*(i-5001),0) - if(i>6001,-0.0114*(i-6001),0)";
params.force_model.stretch.scaleFunc += " + if(i>6001, 0.0093*(i-6001),0) - if(i>7001, 0.0093*(i-7001),0)";
